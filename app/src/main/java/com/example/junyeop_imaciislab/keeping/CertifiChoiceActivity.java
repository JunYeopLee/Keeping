...
public class CertifiChoiceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        init();
        findViewById(R.id.btn_choice_refresh).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resume();
            }
        });
        activityFrom = getIntent().getExtras().getString("activityFrom");
    }
    ...
    private class InventoryListAsyncHttpResponseHandler extends JsonHttpResponseHandler {
        ...
        @Override
        public void onStart() {
            dialog = new ProgressDialog(CertifiChoiceActivity.this);
        ...
        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
            try {
                if(response.getBoolean("success")) {
                    ...
                    certifiChoiceListAdapter = new CertifiChoiceListAdapter((Activity)this.context,inventoryListDAOArrayList);
                    inventoryListview = (ListView)findViewById(R.id.listview_cardlist);
                    inventoryListview.setAdapter(certifiChoiceListAdapter);
                    ...
                    AlertDialog.Builder alert = new AlertDialog.Builder(CertifiChoiceActivity.this);
